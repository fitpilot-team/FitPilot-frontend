...
function normalizeAnswers(answers: QuestionnaireAnswers): QuestionnaireAnswers {
  ...
  return {
    ...
    document_id: answers.document_id?.trim() || undefined,
    phone: answers.phone?.trim() || undefined,
    address: answers.address?.trim() || undefined,
    emergency_contact_name: answers.emergency_contact_name?.trim() || undefined,
    emergency_contact_phone: answers.emergency_contact_phone?.trim() || undefined,
    insurance_provider: answers.insurance_provider?.trim() || undefined,
    policy_number: answers.policy_number?.trim() || undefined,
