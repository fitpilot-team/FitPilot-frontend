    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          <motion.div
            className="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700
            ...
            >
              <motion.div
                className={`
                  ...
                  ${isActive
                    ? 'bg-gradient-to-r from-blue-500/10 to-blue-600/5 text-blue-700'
        ...
        {selectedClient && (
          ...
          >
            ...
            <div className="px-3 py-2">
              <div className="flex items-center gap-3">
                <motion.div
                  className="flex-shrink-0 w-9 h-9 rounded-lg bg-gradient-to-br from-emerald-500 to-teal-600
                  ...
                  >
                    <motion.div
                      className={`
                        ...
                        transition-all duration-200 relative overflow-hidden
                        ${isActive
                          ? 'bg-gradient-to-r from-emerald-500/10 to-teal-600/5 text-emerald-700'
                          : 'text-gray-600 hover:bg-gray-100/80 hover:text-gray-900'
                        }
                      `}
                      whileHover={{ x: 4 }}
                    ...
                    >
                      ...
                      <motion.div
                        className={`flex-shrink-0 p-2 rounded-lg transition-colors duration-200
                          ${isActive
                            ? 'bg-gradient-to-br from-emerald-500 to-teal-600 shadow-md shadow-emerald-500/25'
                            : 'bg-gray-100 group-hover:bg-gray-200'
                          }`}
                        whileHover={{ scale: 1.1 }}
                      >
      ...
      {user && (
        <motion.div
          className="px-3 py-4 border-t border-gray-100 bg-gradient-to-r from-gray-50/50 to-transparent"
          layout
        >
          <div className="flex items-center gap-3">
            <motion.div
              className="flex-shrink-0 h-10 w-10 rounded-xl bg-gradient-to-br from-blue-500 to-blue-700
