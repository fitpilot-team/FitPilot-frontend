...
import { PlusIcon, PencilIcon, TrashIcon, SparklesIcon, MoonIcon, Bars3Icon } from '@heroicons/react/24/outline';
        ...
        <div className={`p-3 bg-gradient-to-b from-emerald-50 to-white border-b border-emerald-100`}>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-0.5">
              <label className="flex items-center" title={t('trainingDay.copyMode')}>
                <input
                  type="checkbox"
                  checked={copyMode}
              ...
              <motion.button
                ...
                className={`p-1.5 rounded-lg transition-colors ${
                  copyMode
                    ? 'text-gray-400 hover:text-gray-600 hover:bg-white/60 cursor-grab active:cursor-grabbing'
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-0.5">
            ...
            <motion.button
              ...
              className={`p-1.5 rounded-lg transition-colors ${
                copyMode
                  ? 'text-gray-400 hover:text-gray-600 hover:bg-gray-100/60 cursor-grab active:cursor-grabbing'
                  : 'text-gray-200 cursor-not-allowed'
              }`}
            >
              <Bars3Icon className="h-3.5 w-3.5" />
