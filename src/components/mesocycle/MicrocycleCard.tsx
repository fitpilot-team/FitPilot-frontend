...
interface MicrocycleCardProps {
  ...
  onEdit?: () => void;
  onDelete?: () => void;
  onCloneMicrocycle?: () => void;
  onCloneTrainingDays?: () => void;
              ...
              <div className="flex items-center gap-1">
                ...
                {onCloneMicrocycle && (
                  <Button
                    ...
                    title={t('training:microcycle.clone')}
                  >
                ...
                {onCloneTrainingDays && (
                  <Button
                    ...
                    title={t('training:trainingDay.cloneDays.title')}
                  >
            ...
            kanbanEnabled && (
              <div className="h-[700px] overflow-hidden rounded-xl">
                <MicrocycleKanbanBoard
                  ...
                  onCloneTrainingDay={onCloneTrainingDay}
