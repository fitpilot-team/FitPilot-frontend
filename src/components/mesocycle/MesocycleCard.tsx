...
interface MesocycleCardProps {
  ...
  onCloneMicrocycle?: (microcycleId: string) => void;
  onCloneTrainingDays?: (microcycleId: string) => void;
  onCloneTrainingDay?: (microcycleId: string, sourceDayId: string, insertionIndex: number) => Promise<void>;
                    ...
                    {activeMicrocycle && (
                      <>
                        ...
                        <MicrocycleCard
                          ...
                          onCloneMicrocycle={() => onCloneMicrocycle?.(activeMicrocycle.id)}
                          onCloneTrainingDays={() => onCloneTrainingDays?.(activeMicrocycle.id)}
                          onCloneTrainingDay={(sourceDayId, insertionIndex) =>
                            onCloneTrainingDay?.(activeMicrocycle.id, sourceDayId, insertionIndex) ?? Promise.resolve()
                          }
