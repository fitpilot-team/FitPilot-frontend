...
const INTERVIEW_STEPS = ['personal', 'profile', 'goals', 'availability', 'equipment', 'restrictions'];

// Steps for template mode (all steps including preferences/duration)
const TEMPLATE_STEPS = ['personal', 'profile', 'goals', 'availability', 'equipment', 'restrictions', 'preferences'];
