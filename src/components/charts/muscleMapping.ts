...
export const MUSCLE_ID_TO_GROUP: Record<string, MuscleName> = {
  ...
  'Lateral_deltoid_right': 'lateral_deltoid',
  'Lateral_deltoid_right1': 'lateral_deltoid',
  ...
  // =====================================
  // POSTERIOR VIEW - Forearms (4 elements)
  // =====================================
  'Left_extensor_digiti_minimi': 'forearms',
  'Left_extensor_carpi_ulnaris': 'forearms',
  'Right_extensor_digiti_minimi': 'forearms',
  'Right_extensor_carpi_ulnaris': 'forearms',
  ...
  'glutes_right_minimus': 'glutes',
  'glutes_left_minimus': 'glutes',

  // =====================================
  // POSTERIOR VIEW - Hamstrings (5 elements)
  // =====================================
  'hamstrings_left_biceps_femoris': 'hamstrings',
...
export const MUSCLE_LABELS: Record<string, string> = {
  ...
  'Lateral_deltoid_right': 'Right Lateral Deltoid',
  'Lateral_deltoid_right1': 'Left Lateral Deltoid',
  ...
  // Posterior View - Forearms
  'Left_extensor_digiti_minimi': 'Left Forearm',
  'Left_extensor_carpi_ulnaris': 'Left Forearm',
  'Right_extensor_digiti_minimi': 'Right Forearm',
  'Right_extensor_carpi_ulnaris': 'Right Forearm',

  // Posterior View - Glutes
  'glutes_left_maximus': 'Left Gluteus Maximus',
  'glutes_right_maximus': 'Right Gluteus Maximus',
  'glutes_right_minimus': 'Right Gluteus Minimus',
  'glutes_left_minimus': 'Left Gluteus Minimus',

  // Posterior View - Hamstrings
  'hamstrings_left_biceps_femoris': 'Left Biceps Femoris',
...
export const MAPPED_MUSCLE_GROUPS: MuscleName[] = [
  ...
  'forearms',           // Forearms (posterior view)
